...
<body>
	<div class="container text-center">
		...
		<div class="content-404">
			...
			<h2><a href="<?php echo _WEB_ROOT; ?>/trang-chu">Bring me back Home</a></h2>
		</div>
	</div>
	...
	<script src="<?php echo _WEB_ROOT; ?>/public/frontend/js/jquery.scrollUp.min.js"></script>
	<script src="<?php echo _WEB_ROOT; ?>/public/frontend/js/price-range.js"></script>
    <script src="<?php echo _WEB_ROOT; ?>/public/frontend/js/jquery.prettyPhoto.js"></script>
