							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="<?php echo _WEB_ROOT; ?>/public/uploads/product_thumbnail/<?php echo $search_prod['thumbnail'] ?>" alt="" />
											<h2><?php echo number_format($search_prod['regular_price']) ?> VND</h2>
											<p><?php echo $search_prod['name'] ?></p>
											
										</div>
										<div class="product-overlay">
											<div class="overlay-content">
												<h2><?php echo number_format($search_prod['regular_price']) ?> VND</h2>
												<a href="<?php echo _WEB_ROOT; ?>/chi-tiet-sp/chitiet-<?php echo $search_prod['id'] ?>">
												   <p><?php echo $search_prod['name'] ?></p>
												</a>
